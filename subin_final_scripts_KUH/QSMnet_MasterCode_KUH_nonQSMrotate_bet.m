...
%     dirs.ro_t1               = [dirs.DDRIVE '3_nonQSMrotate_BET_210414\' '3_1_1_t1_isonii_fsspace_ro'];
    dirs.betmask           = [dirs.DDRIVE '3_nonQSMrotate_BET_210414\' '3_2_1_betmasks_fsspace'];
    dirs.mag_coreg_fsmask    = [dirs.DDRIVE '3_nonQSMrotate_210409\' '3_2_2_fsmasks_fsspace_magcoreg'];
    dirs.vsharp_betmask  = [dirs.DDRIVE '3_nonQSMrotate_BET_210414\' '3_2_3_betmasks_fsspace_vsharp'];
    dirs.phs_tissue          = [dirs.DDRIVE '3_nonQSMrotate_BET_210414\' '4_QSMnet_input_phstissue'];    
    dirs.steps               = ['Z:\Personal_Folder\Subin\KUH\3_nonQSMrotate_210409\4_QSMnet_input_phstissue' '\steps'];
    dirs.qsmnet    =  [dirs.DDRIVE '3_nonQSMrotate_BET_210414\' '5_0_QSMnet_outputs'];
    dirs.qsmnet_zp =  [dirs.DDRIVE '3_nonQSMrotate_BET_210414\' '5_1_uzip_zp_QSMnet_files'];
...
%     suffix.vsharp     = ['_vsharp_betmask']; % '_dilated' options.dilatenum_str '_eroded' options.erodenum_str];
%     suffix.phs_tissue = ['_phs_tissue_bet']; % '_dilated' options.dilatenum_str '_eroded' options.erodenum_str];
%     suffix.mat        = ['_QSMnetinput_bet' ]; %'_dilated' options.dilatenum_str '_eroded' options.erodenum_str];
%     suffix.qsmnetout    = ['_QSMnet+_64_25_bet']; %'_dilated' options.dilatenum_str '_eroded' options.erodenum_str];
%     suffix.qsmnetout_zp = ['_QSMnet+_64_25_bet' '_zp']; % '_dilated' options.dilatenum_str '_eroded' options.erodenum_str '_zp'];
% end
...
% % 1. Preprocess QSM        
%      pipeline_h_QSM_preprocessing_KUH_nonQSMrotate_bet
% 
% % 2. Resize phs_tissue for QSMnet+
%     pipeline_i_Resize_phstissue_for_QSMnet 
    
% 3. Run spyder ('inference_subin_BET_kuh_final.py'), then run below

% 4. Postprocess QSMnet_ output
   pipeline_j_postprocess_qsmnet_output

% 5. Postprocess ROImask to completely overlap with QSMnet_output
   pipeline_k_make_zeromask_bet
...
% 6. Extract QSM values from ROIs:
    pipeline_l_Extract_ROI_QSMvalues_2