...
for idx = 1:length(subjects)
    ...
    subj = subjects{idx};
        fname_fsroi  = ['D:\subindata\KUH\2_New_210331\6_fsmasks_fsspace_zero' '\flip_v_crop_magcoreg_nn_' subj suffix.FSroimask '.nii'];
        fname_qsm    = [dirs.qsmnet_zp '\' subj '_QSMnet+_64_25_bet.nii'];
