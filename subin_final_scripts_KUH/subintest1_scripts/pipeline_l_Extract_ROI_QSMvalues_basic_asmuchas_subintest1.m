...
regions_dictionary = struct( ...
                            ...
                            'temp_cortex', [1001 1006 1007 1009 1015 1016 1030 1033 1034 2001 2006 2007 2009 2015 2016 2030 2033 2034], ...
                            ...
                            'middlefrontal', [1003 2003 1027 2027], 'orbitofrontal', [1012 2012 1014 2014], 'parsopercularis', [1018 2018], 'parsorbitalis', [1019 2019], 'parstriangularis', [1020 2020], 'superiorfrontal', [1028 2028], 'frontalpole', [1032 2032], ...
                            ...
                            'anteriorcingulate', [1002 2002 1026 2026], 'isthmuscingulate', [1010 2010], 'posteriorcingulate', [1023 2023] ...
                            );
...
for idx = 1:length(subjects)
    ...
    subj = subjects{idx};
        fname_wmparc_v_ras     = [dirs.v_fsbrainmask '\bv_magcoreg_nn_' subj '_wmparc' '_qs_RAS' '.nii'];
        fname_qsmnet_uzip_zref = [dirs.qsmnet_zr '\' subj '_QSMnet_zeroref' '_qs_RAS' '.nii'];
